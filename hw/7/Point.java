public class Point 
{
    ...
    public static Point getIntersectingPoint(double x1,double y1,double x2,double y2,
    ...
    public static Point getIntersectingPoint(Point[] p) 
    {
        return getIntersectingPoint(p[0], p[1], p[2], p[3]);
    }
    public static Point getIntersectingPoint(double[][] points) 
    {
